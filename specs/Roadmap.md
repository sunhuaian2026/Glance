...
|------|------|------|--------|----------|------|
| OpenWith Slice 2 | 浏览所在文件夹 | `specs/OpenWith.md` + `specs/OpenWith-plan.md` Task 2.x | 中 | Slice 1（已完成 `cc78c41`） | QV 加「浏览所在文件夹」按钮：父目录已加直接 selectFolder / 未加 NSOpenPanel 授权后 addFolder。Slice 1 已 ship（外部打开看单图） |
